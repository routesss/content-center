...
import com.sola.contentcenter.util.JwtOperator;
...
public class AuthenticationFilterConfig {
     ...
     * @return
     */
    @Around("@annotation(com.sola.contentcenter.annotation.Authentication)")
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.sola.contentcenter.annotation.AuthenticationRole)")
